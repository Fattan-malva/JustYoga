...
/// Reusable layout (dulu namanya ConsultantScreen Stateful)
class ConsultantLayout extends StatefulWidget {
  ...
  @override
  State<ConsultantLayout> createState() => _ConsultantLayoutState();
}

class _ConsultantLayoutState extends State<ConsultantLayout> {
  @override
...
/// Screen (Stateless) yang menggunakan ConsultantLayout
class ConsultantScreen extends StatelessWidget {
  static const routeName = '/consultant';
    ...
    return ConsultantLayout(
      ...
      headerContent: Column(
        ...
        children: [
          ...
          Text(
            'Helps you understand your body and\nfind the classes that suit your needs best',
